...
static PyObject *
Pyaubio_onset_get_last_onset (Py_onset *self, PyObject *unused)
{
  smpl_t tmp = aubio_onset_get_last_onset (self->o);
  return (PyObject *)PyFloat_FromDouble (tmp);
}

static PyObject *
Pyaubio_onset_get_last_onset_s (Py_onset *self, PyObject *unused)
{
  smpl_t tmp = aubio_onset_get_last_onset_s (self->o);
  return (PyObject *)PyFloat_FromDouble (tmp);
}

static PyObject *
Pyaubio_onset_get_last_onset_ms (Py_onset *self, PyObject *unused)
{
  smpl_t tmp = aubio_onset_get_last_onset_ms (self->o);
  return (PyObject *)PyFloat_FromDouble (tmp);
}
...
static PyMethodDef Py_onset_methods[] = {
  ...
  {"set_delay_ms", (PyCFunction) Pyaubio_onset_set_delay_ms,
    METH_VARARGS, ""},
  {"get_last_onset", (PyCFunction) Pyaubio_onset_get_last_onset,
    METH_NOARGS, ""},
  {"get_last_onset_s", (PyCFunction) Pyaubio_onset_get_last_onset_s,
    METH_NOARGS, ""},
  {"get_last_onset_ms", (PyCFunction) Pyaubio_onset_get_last_onset_ms,
    METH_NOARGS, ""},
